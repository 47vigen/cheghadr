const fa = {
  bot: {
    ...
    prices: {
      ...
      prev: '◀️ قبلی',
      next: 'بعدی ▶️',
      backToCategories: '↩️ دسته‌بندی‌ها',
    },
    alerts: {
    ...
    assets: {
      ...
      wizard: {
        ...
        cancelled: '↩️ افزودن دارایی لغو شد.',
        cancel: '✖️ لغو',
      },
    },
    settings: {
